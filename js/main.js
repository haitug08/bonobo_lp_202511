...
$(function() {
  ...
  $('a[href^="#"], .pagetop').click(function(e) {
    ...
    var scrollTo = id === '#' ? 0 : $(id).offset().top;
  ...
  $(window).scroll(function() {
    if($(this).scrollTop() >= 300) {
      topButton.fadeIn().addClass('pagetop-show');
    } else {
      topButton.fadeOut().removeClass('pagetop-show');
    }
  });
});
...
/* ===============================================================
   スクロール連動処理（Sticky見出し ＆ パララックス背景）
   =============================================================== */
$(document).ready(function() {
    // パララックス対象
    var $parallaxTarget = $('.list-grid7 .list');
...
/* ===============================================================
   ...
   =============================================================== */
$(function() {
  // ※注意：jquery.inview.js プラグインが読み込まれている必要があります
  if ($.isFunction($.fn.inview)) { // エラー防止のチェック
